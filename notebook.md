...
clinic_2.plot(y="proportion_deaths", x="year", label="Clinic 2", ax=ax, ylabel="Proportion deaths")
```
...
ax = monthly.plot(x="date", y="proportion_deaths", ylabel="Proportionn deaths")
```
...
after_washing.plot(x="date", y="proportion_deaths", ax=ax, label="After Washing", ylabel="Proportionn deaths")
```




    <AxesSubplot:xlabel='date', ylabel='Proportionn deaths'>
